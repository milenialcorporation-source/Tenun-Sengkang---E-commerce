                ...
                <div className="relative aspect-square mb-3 bg-gray-100 border border-gray-200 overflow-hidden w-full">
                  <Link href={`/product/${product.id}`} className="block w-full h-full relative">
                    <Image 
                      ...
                      alt={product.name} 
                      fill 
                      className={`object-contain transition-opacity duration-500 ${(Array.isArray(product.images) && product.images.length > 0) ? 'group-hover:opacity-0' : 'group-hover:opacity-90'}`}
