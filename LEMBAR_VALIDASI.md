...
**Judul**          : Rancang Bangun Sistem Informasi E-Commerce
**Nama**           : [Nama Anda]
**NIM**            : [NIM Anda]
...
### A. Tujuan Instrumen
Instrumen ini bertujuan untuk menilai kinerja dan fungsionalitas dari Sistem Informasi E-Commerce.

### B. Petunjuk Pengisian
1. Lembar validasi ini diisi oleh validator yang menilai kinerja dari Sistem Informasi E-Commerce.
2. Mohon kiranya Bapak/Ibu untuk memberikan validasi dengan memberi tanda centang (√) pada kolom jawaban **(Ya/Tidak)** sesuai dengan hasil penilaian yang Bapak/Ibu berikan.
3. Berilah tanda (=) pada jawaban yang salah, dan berilah tanda centang (√) baru pada jawaban yang benar jika ada kesalahan.
4. Jika Bapak/Ibu ingin memberikan komentar ataupun saran, silahkan mengisi isian pada bagian E (Komentar dan Saran).
5. Berilah tanda centang (√) pada salah satu pilihan mengenai hasil penilaian Bapak/Ibu pada bagian F (Kesimpulan Hasil Validasi).
...
| NO | Use Case Yang Diuji | Hasil Yang Diharapkan | Ya | Tidak |
|:---:|---|---|:---:|:---:|
...
| | Halaman Login Admin | Gagal masuk jika password atau email admin salah | | |
| 7 | Dashboard Admin | Menampilkan menu navigasi produk, kategori, dan tampilan | | |
| 8 | Kelola Data Produk | Menampilkan daftar seluruh produk dalam bentuk tabel/list | | |
| | Kelola Data Produk | Fitur tambah produk berfungsi (simpan nama, harga, deskripsi) | | |
| | Kelola Data Produk | Perubahan (edit/hapus) data produk berhasil disimpan ke sistem | | |
| 9 | Kelola Data Kategori | Admin dapat menambah dan mengubah nama kategori produk | | |
| 10 | Kelola Konten / Halaman | Admin dapat mengubah konten Banner (Hero Section) website | | |
| | Kelola Konten / Halaman | Perubahan konten dari admin langsung tampil di halaman depan user | | |
...
### F. Kesimpulan Hasil Validasi

[ &nbsp; &nbsp; ] Layak untuk Uji Coba Lapangan  
[ &nbsp; &nbsp; ] Layak untuk Uji Coba Lapangan dengan Revisi  
[ &nbsp; &nbsp; ] Tidak Layak untuk Uji Coba Lapangan  

Demikian surat keterangan validasi ini dibuat agar dapat digunakan dalam pengumpulan data.
